...
const bottomTabs = [
  { label: "Cuentas", active: true, icon: "accounts" },
  { label: "Pagar y Transferir", active: false, icon: "pay" },
  { label: "Depositar cheques", active: false, icon: "deposit" },
  { label: "Invertir", active: false, icon: "invest" },
] as const;
...
const wealthActions = [
  ...
  { label: "Nueva\nmeta", icon: "goal" },
  { label: "Hablar con\nasesor", icon: "advisor" },
  { label: "Actualizar\nprioridades", icon: "update" },
] as const;

const wealthMenuItems = [
  {
    title: "Ingreso proyectado de retiro",
    description: "Revise como el crecimiento indexado puede respaldar retiros futuros.",
  },
  {
    title: "Estrategia con ventajas fiscales",
    description: "Vea como el valor de la poliza puede utilizarse de forma eficiente.",
  },
  {
    title: "Valor en efectivo protegido",
    description: "Siga la acumulacion disenada para planificacion de largo plazo.",
  },
] as const;
  ...
  return (
    <div className={styles.chartFrame}>
      <svg aria-hidden="true" viewBox="0 0 340 220" className={styles.chartSvg}>
        ...
        <text x="30" y="212" className={styles.chartDateLabel}>Ano 1</text>
        <text x="158" y="212" textAnchor="middle" className={styles.chartDateLabel}>Ano 3</text>
        <text x="286" y="212" textAnchor="end" className={styles.chartDateLabel}>Ano 5</text>
      </svg>
    </div>
  );
}
  ...
  return (
    <div className={styles.noticeBackdrop} role="presentation">
      <section className={styles.noticeSheet} role="dialog" aria-modal="true" aria-labelledby="account-closed-title">
        ...
        <button type="button" className={styles.noticePrimaryButton} onClick={onClose}>Entendido</button>
      </section>
    </div>
  );
}
  ...
  return (
    <header className={styles.appHeader}>
      ...
      <div className={styles.topTabs}>
        <button type="button" className={styles.topTabActive}>Cuentas</button>
        <button type="button" className={styles.topTab}>Panel</button>
      </div>
    </header>
  );
}
    ...
    <>
      ...
      <section className={styles.content} data-boa-content-start>
        ...
        <article className={styles.profileCard}>
          ...
          <button type="button" className={styles.profileRow} onClick={() => setScreen("wealth")}>
            <div>
              ...
              <p>Sus siguientes pasos y nuevas caracteristicas a un toque.</p>
            </div>
            <ChevronRight />
          </button>
        </article>
              ...
              >
                ...
                <div className={styles.accountBalanceWrap}>
                  ...
                  <button
                    ...
                    aria-label={visibleBalances[account.name] ? "Ocultar monto de la cuenta" : "Mostrar monto de la cuenta"}
        ...
        <section className={styles.dealsCard}>
          ...
          <p>Ofertas seleccionadas para sus compras diarias y recompensas.</p>
