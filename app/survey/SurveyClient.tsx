...
export default function SurveyClient() {
  ...
  return (
    <main className="min-h-screen bg-[#f6f7f9] text-[#0f172a]">
      <div className="mx-auto min-h-screen w-full max-w-[430px] bg-[#f6f7f9] shadow-[0_0_0_1px_rgba(207,216,227,0.9)]">
        <header className="border-b border-[#e7ebf0] bg-white shadow-[0_10px_28px_rgba(15,23,42,0.05)]">
        ...
        <section className="px-3.5 pb-14 pt-10">
          ...
          {step === 0 && (
            <div className="pt-12">
              <h1 className="max-w-[11.5ch] text-[2.05rem] font-bold leading-[1.02] tracking-[-0.055em] text-[#07152d]">
          ...
          {step === 1 && (
            <div className="pt-12">
              <h1 className="max-w-[13.4ch] text-[2.05rem] font-bold leading-[1.02] tracking-[-0.055em] text-[#07152d]">
          ...
          {step === 2 && (
            <div className="pt-12">
              <h1 className="text-center text-[2.05rem] font-bold leading-[1.02] tracking-[-0.055em] text-[#07152d]">
                Cual es tu ZIP code?
              </h1>
              <div className="mt-8">
                <TextField
                  ...
                  type="text"
                />
                <p className="mt-4 text-[0.95rem] leading-6 text-[#6b7280]">
          ...
          {step === 3 && (
            <div className="pt-12">
              <h1 className="max-w-[13.2ch] text-[2.05rem] font-bold leading-[1.02] tracking-[-0.055em] text-[#07152d]">
